    ...
    return (
      <React.Fragment>
        <Routes>
          ...
          <Route path="/role" element={<Role sideToggle={this.props.sideToggle} employee={this.state.employeeData} currEmployee={this.state.employee} setEmployee={this.setEmployee} />} />
          <Route path="/edit" element={<IndividualEmployeeRole sideToggle={this.props.sideToggle} employee={this.state.employeeData} currEmployee={this.state.employee} access={this.state.access}/>} />
        </Routes>
